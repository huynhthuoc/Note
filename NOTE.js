...
//form Register
const formElementRegister =
  document.getElementById("register"); //RGT

const inputElementsRGT =
  formElementRegister.querySelectorAll(
    ".forms_register input"
  );
const iputNameRGT =
  formElementRegister.querySelector("#firstName");
const inputEmailRGT =
  formElementRegister.querySelector("#email");
const inputPasswordRGT =
  formElementRegister.querySelector("#password");
const inputPassword_confirmRGT =
  formElementRegister.querySelector("#password_confirm");

const submitElemenRGT = formElementRegister.querySelector(
  "#submit_register"
);
//end from Register
...
style.width = "calc((" + width + "px - 600px) / 2)";

//import style Toastify React
